...
def prepare_graph(name: str, n: int = 0, **kwargs) -> CayleyGraphDef:
    ...
    Supported graphs:
      ...
      * "three_cycles" - Cayley graph for S_n (n ≥ 3), generated by all 3-cycles (a, b, c) where a < b, a < c.
      * "three_cycles_0ij" – Cayley graph for S_n (n ≥ 3), generated by 3-cycles of the form (0 i j), where i != j.
